	...
	public class ARPGCell extends AreaBehavior.Cell{
		/// Type of the cell following the enum
				...
				protected boolean canEnter(Interactable entity) {
					// For flyable entities
					if (type.isFlyable && entity instanceof FlyableEntity) return true;
					if (type.isWalkable && hasNonTraversableContent() && entity instanceof FlyableEntity) return true;

					if (hasNonTraversableContent()) return false;
